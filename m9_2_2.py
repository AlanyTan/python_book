...
class LicensePlate:
    ...
    def __init__(self, plate_number: str, expiry_date: datetime = None):
    ...
    def renew(self, expiry_date: datetime = None):
        ...
        if expiry_date is None:
            expiry_date = datetime.now() + 365*24*3600
        else:
...
class Engine:
    ...
    def __init__(self, make: str, model: str,
                 type_: str = "gasoline", cylinders: int = 4
...
class Car(Vehicle):
    ...
    def __init__(self, type_: str = None, cylinders: int = 4,
