...
#DEBUG - m6_2_4_module(m6_2_4_module.py:9) - entering module root level['logger', 'logging']
...
import_in_func()
#DEBUG - main_script(m6_2_4.py:30) - import_in_func() called dir()=[]
#==first level globals:
#  ('logging', <module 'logging' from 'C:\\Users\\user\\AppData\\Local\\Programs\\Python\\Python312\\Lib\\logging\\__init__.py'>)
#  ('logger', <Logger main_script (DEBUG)>)
#  ('circle', <module 'm6_1_circle' from 'C:\\Users\\user\\Documents\\python_book\\m6_1_circle.py'>)
...
#DEBUG - main_script(m6_2_4.py:39) - import_in_func() ending dir()=['local_ns_func']
