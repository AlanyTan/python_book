...
print(f"# {tuple_2 == tuple_2_other=}, {tuple_2 is tuple_2_other=}")
# tuple_2 == tuple_2_other=True, tuple_2 is tuple_2_other=False

print(f"# {tuple_2[0] == tuple_2_other[0]=}, "
      f"{tuple_2[0] is tuple_2_other[0]=}")
# tuple_2[0] == tuple_2_other[0]=True, tuple_2[0] is tuple_2_other[0]=False

tuple_2[0].append("2")
print(f"# {tuple_2_alias}, {tuple_2_copy=}, {tuple_2_other=}")
# ([1, '2'], '3', 4.0), tuple_2_copy=([1, '2'], '3', 4.0), tuple_2_other=([1], '3', 4.0)

print(f"# {tuple_2 > tuple_2_other=}")
# tuple_2 > tuple_2_other=True
