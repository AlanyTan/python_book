...
# ('m6_3_package', <module 'm6_3_pac5kage' from 'C:\\Users\\user\\Documents\\python_book\\m6_3_package\\__init__.py'>)
...
print("#=2.root level dir(mod_1)", [
      d for d in dir(mod_1) if not d.startswith('__')])
#=2.root level dir(mod_1) ['func_in_mod_1', 'logger', 'logging', 'var_mod_1']
print("#=2.root level dir(m6_3_package.module_1)", [
      d for d in dir(m6_3_package.module_1) if not d.startswith('__')])
#=2.root level dir(m6_3_package.module_1) ['func_in_mod_1', 'logger', 'logging', 'var_mod_1']
print("#=2.root level "
      f"{mod_1.func_in_mod_1 is m6_3_package.module_1.func_in_mod_1=}")
