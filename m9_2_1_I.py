...
class Parallelogram:
    ...
    def long_side(self, l: int|float) -> None:
        if l < 0:
            logger.error(f"Parallelogram.long_side setter: invalid length {l=}!")
    ...
    def short_side(self, s: int|float) -> None:
        if s < 0:
            logger.error(f"Parallelogram.short_side setter: invalid length {s=}!")
    ...
    def acute_angle(self, aa: int|float) -> None:
        if 0 <= aa <= 90:
            logger.debug(f"Parallelogram acute_angle setter: called with {aa=}.")
    ...
    def __init__(self, l: int|float, s: int|float, aa: int|float
                 , oa: int|float = None):
...
#DEBUG - __main__(m9_2_1_I.py:21) - defining class Parallelogram.
#DEBUG - __main__(m9_2_1_I.py:137) - defining class Rectangle based on Parallelogram
#DEBUG - __main__(m9_2_1_I.py:107) - Parallelogram.__init__()
#DEBUG - __main__(m9_2_1_I.py:39) - Parallelogram.long_side setter: called with l=4.
#DEBUG - __main__(m9_2_1_I.py:59) - Parallelogram short_side setter: called with s=3.
#DEBUG - __main__(m9_2_1_I.py:70) - Parallelogram acute_angle setter: called with aa=30.
#DEBUG - __main__(m9_2_1_I.py:125) - - Parallelogram.height()
# para_1.area()=5.999999999999999
#DEBUG - __main__(m9_2_1_I.py:140) - -Rectangle.__init__()
#DEBUG - __main__(m9_2_1_I.py:107) - Parallelogram.__init__()
#DEBUG - __main__(m9_2_1_I.py:39) - Parallelogram.long_side setter: called with l=4.
#DEBUG - __main__(m9_2_1_I.py:59) - Parallelogram short_side setter: called with s=3.
#DEBUG - __main__(m9_2_1_I.py:70) - Parallelogram acute_angle setter: called with aa=90.
#DEBUG - __main__(m9_2_1_I.py:144) - -Rectangle.height()
# rect_1.area()=12
