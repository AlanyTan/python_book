...
def main(file_name: str) -> None:
    ...
    student_record_dict = [{'ID': 1.0, 'Name': 'Alice', 'Age': 18.0, 
                            'Grade': 80.5, 'Pass/Fail': 'True'},
                    {'ID': 2.0, 'Name': 'Bob', 'Age': 19.0, 
                     'Grade': 70.0, 'Pass/Fail': 'True'},
                    {'ID': 3.0, 'Name': 'Carole', 'Age': 17.0, 
                     'Grade': 75.0, 'Pass/Fail': 'True'},
                    {'ID': 4.0, 'Name': 'David', 'Age': 18.0, 
...
# type(stu_rec)=<class 'list'>: [1.0, 'Alice', 18.0, 80.5, 'True']
# type(stu_rec)=<class 'list'>: [2.0, 'Bob', 19.0, 70.0, 'True']
# type(stu_rec)=<class 'list'>: [3.0, 'Carole', 17.0, 75.0, 'True']
# type(stu_rec)=<class 'list'>: [4.0, 'David', 18.0, 85.5, 'True']
# type(stu_rec)=<class 'dict'>: {'ID': 1.0, 'Name': 'Alice', 'Age': 18.0, 'Grade': 80.5, 'Pass/Fail': 'True'}
# type(stu_rec)=<class 'dict'>: {'ID': 2.0, 'Name': 'Bob', 'Age': 19.0, 'Grade': 70.0, 'Pass/Fail': 'True'}
# type(stu_rec)=<class 'dict'>: {'ID': 3.0, 'Name': 'Carole', 'Age': 17.0, 'Grade': 75.0, 'Pass/Fail': 'True'}
# type(stu_rec)=<class 'dict'>: {'ID': 4.0, 'Name': 'David', 'Age': 18.0, 'Grade': 85.5, 'Pass/Fail': 'True'}
