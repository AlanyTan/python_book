...
#=root level dir() ['CONST_INIT', 'm6_3_2_geometry', 'module_1']

print(f"#-{module_1.func_in_mod_1()=}")
#-module_1.func_in_mod_1()='func defined in module_1 under m6_3_package'

print(f"#-{CONST_INIT=}")
#-CONST_INIT='defined in package __init__.py'

print(f"#-{m6_3_2_geometry.CONST_1=}")
#-m6_3_2_geometry.CONST_1='defined in sub package __init__.py'
